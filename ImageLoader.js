...
export default class ImageLoader {
  ...
  // Arion sprites
  spritesArion() {
    this.scene.load.spritesheet( 'arion-walking', 'images/people/arion/arion-walking.png', {
      frameWidth: 80,
      frameHeight: 120,
    } );
    this.scene.load.spritesheet( 'arion-standing', 'images/people/arion/arion-standing.png', {
      frameWidth: 80,
      frameHeight: 115,
    } );
    this.scene.load.spritesheet( 'arion-sick', 'images/people/arion/arion-sick.png', {
      frameWidth: 90,
      frameHeight: 120,
    } );
    this.scene.load.spritesheet( 'arion-eating', 'images/people/arion/arion-eating.png', {
      frameWidth: 96,
      frameHeight: 120,
    } );
    this.scene.load.spritesheet( 'arion-ring-cowbell-down', 'images/people/arion/arion-cowbell-down.png', {
      frameWidth: 120,
      frameHeight: 180,
    } );
    this.scene.load.spritesheet( 'arion-ring-cowbell-up', 'images/people/arion/arion-cowbell-up.png', {
      frameWidth: 100,
      frameHeight: 150,
    } );
    this.scene.load.spritesheet( 'arion-ring-cowbell-left', 'images/people/arion/arion-cowbell-left.png', {
      frameWidth: 150,
      frameHeight: 160,
    } );
    this.scene.load.spritesheet( 'arion-ring-cowbell-right', 'images/people/arion/arion-cowbell-right.png', {
      frameWidth: 150,
      frameHeight: 160,
    } );
  }
